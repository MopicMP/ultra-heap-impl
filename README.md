...
> Ultra min-heap and max-heap implementation

[![PyPI version](https://badge.fury.io/py/ultra-heap-impl.svg)](https://pypi.org/project/ultra-heap-impl/)
...
```bash
pip install ultra-heap-impl
```

## Quick Start

```python
from ultra_heap_impl import impl
...
from ultra_heap_impl import batch
